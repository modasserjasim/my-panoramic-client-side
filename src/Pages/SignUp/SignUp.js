        ...
        <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300 -z-10">
            ...
            <form onSubmit={handleSignUp} className="my-10">
                <div className="flex flex-col space-y-5">
                    ...
                    <p className="text-center">Already have an account? <Link to='/login' className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Login now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
