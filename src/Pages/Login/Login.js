            ...
            <form action="" className="my-10">
                <div className="flex flex-col space-y-5">
                    ...
                    <div className="flex flex-row justify-end">
                        <div>
                            <Link to='/forgot-password' className="font-medium text-indigo-600">Forgot Password?</Link>
                        </div>
                    </div>
                    ...
                    <p className="text-center">Not signup yet? <Link to='/signup' className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Signup now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
