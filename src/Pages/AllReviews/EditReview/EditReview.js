...
const EditReview = () => {
    ...
    return (
        <div className="p-4 md:p-10 mx-auto my-20 rounded-md max-w-3xl bg-gray-100">
            <h2 className="text-3xl mb-5 font-semibold text-gray-700 dark:text-white">Edit Your Review</h2>
            <h3 className='text-xl'>Service Name: <span className='font-bold text-green-600'> {review.serviceName}</span></h3>
            <form onSubmit={handleEditReview}>
                <div className='mt-8'>

                    <div>
                        <label className="text-gray-700 dark:text-gray-200" htmlFor="review">Update your review</label>
                        <textarea name='review' defaultValue={review.review} type="textarea" className="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring h-32" rows="5"
